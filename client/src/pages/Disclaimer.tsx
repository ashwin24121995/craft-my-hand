...
export default function Disclaimer() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>Color:</strong> Colors may appear slightly different from reference images due to the natural flow of resin pigments and differences in screen displays.</li>
        <li><strong>Texture:</strong> Surface texture may vary slightly between pieces due to the curing process and hand-finishing techniques.</li>
        <li><strong>Pattern:</strong> Resin naturally flows and settles during the curing process, which means patterns may differ from reference images even when the same technique is used.</li>
        <li><strong>Finish:</strong> The final finish may have minor variations depending on the materials and techniques used for each specific piece.</li>
      </ul>
      <p>
        These variations are inherent to handmade art and are considered part of the character and
        uniqueness of each piece. They are not defects and do not qualify for refunds or replacements.
      </p>
      ...
      <p>
        The images displayed on this website are examples of past custom work and are intended to
        showcase the type of resin art we create. These images do not represent products available
        for direct purchase. Your custom order will be created based on your specific requirements
        and may differ from the images shown.
      </p>
      ...
      <p>
        ...
        privacy practices, or availability of those external sites. Inclusion of any external link
